    ...
    def _build_default_patterns(self) -> list[FailurePattern]:
        ...
        return [
            ...
            FailurePattern(
                ...
                keywords=["no matches found", "element not found", "unable to find", "doesn't exist", "did not exist"],
                regex_patterns=[
                    ...
                    r"did NOT exist",
                    r"StaticText did NOT exist",
                    r"Button did NOT exist",
                    r"TextField did NOT exist",
                ],
            ...
            FailurePattern(
                ...
                severity=FailureSeverity.MEDIUM,
                keywords=["timed out", "timeout", "exceeded time limit", "wait expired", "within"],
                regex_patterns=[
                    r"Timed out waiting",
